...
func (DeviceCapabilities_ModelRuntimeInfo_ModelRuntimeType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_fdaf1f89158d2cba, []int{15, 0, 0}
}
...
func (DeviceCapabilities_CameraInfo_CameraDriver) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_fdaf1f89158d2cba, []int{15, 1, 0}
}
...
func (*DeviceCapabilities_ModelRuntimeInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_fdaf1f89158d2cba, []int{15, 0}
}
...
type DeviceCapabilities_CameraInfo struct {
	...
	CameraID int64                                      `protobuf:"varint,2,opt,name=camera_id,json=cameraId,proto3" json:"camera_id,omitempty"`
}
...
func (*DeviceCapabilities_CameraInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_fdaf1f89158d2cba, []int{15, 1}
}
...
func (m *DeviceCapabilities_CameraInfo) GetCameraID() int64 {
	if m != nil {
		return m.CameraID
	}
	return 0
...
var fileDescriptor_fdaf1f89158d2cba = []byte{
	...
	,
}
...
func (m *DeviceCapabilities_CameraInfo) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.CameraID != 0 {
		i = encodeVarintCpEdge(dAtA, i, uint64(m.CameraID))
		i--
		dAtA[i] = 0x10
	}
	if m.Driver != 0 {
...
func (m *DeviceCapabilities_CameraInfo) Size() (n int) {
	...
	if m.CameraID != 0 {
		n += 1 + sovCpEdge(uint64(m.CameraID))
	}
	return n
}
