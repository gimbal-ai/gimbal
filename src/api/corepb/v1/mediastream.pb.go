...
type ImageQualityMetrics struct {
	...
	Blurriness   float64 `protobuf:"fixed64,2,opt,name=blurriness,proto3" json:"blurriness,omitempty"`
}
...
func (m *ImageQualityMetrics) GetBlurriness() float64 {
	if m != nil {
		return m.Blurriness
	}
	return 0
...
var fileDescriptor_d0e2e756820efd7b = []byte{
	...
	,
}
...
func (this *ImageQualityMetrics) Equal(that interface{}) bool {
	...
	if this.Blurriness != that1.Blurriness {
		return false
	}
	return true
}
...
func (this *ImageQualityMetrics) GoString() string {
	...
	s = append(s, "Blurriness: "+fmt.Sprintf("%#v", this.Blurriness)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
...
func (m *ImageQualityMetrics) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.Blurriness != 0 {
		i -= 8
		encoding_binary.LittleEndian.PutUint64(dAtA[i:], uint64(math.Float64bits(float64(m.Blurriness))))
		i--
		dAtA[i] = 0x11
	}
	if m.BrisqueScore != 0 {
...
func (this *ImageQualityMetrics) String() string {
	...
	s := strings.Join([]string{`&ImageQualityMetrics{`,
		...
		`Blurriness:` + fmt.Sprintf("%v", this.Blurriness) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *ImageQualityMetrics) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 1 {
				return fmt.Errorf("proto: wrong wireType = %d for field Blurriness", wireType)
			}
			var v uint64
			if (iNdEx + 8) > l {
				return io.ErrUnexpectedEOF
			...
			v = uint64(encoding_binary.LittleEndian.Uint64(dAtA[iNdEx:]))
			iNdEx += 8
			m.Blurriness = float64(math.Float64frombits(v))
		default:
			iNdEx = preIndex
			skippy, err := skipMediastream(dAtA[iNdEx:])
			if err != nil {
