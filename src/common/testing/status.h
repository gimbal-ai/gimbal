...
#undef EXPECT_OK
#endif
#define EXPECT_OK(value) EXPECT_TRUE(IsOK(::gml::StatusAdapter(value)))
...
#define ASSERT_HAS_VALUE_AND_ASSIGN(lhs, rexpr) \
  ASSERT_HAS_VALUE_AND_ASSIGN_IMPL(GML_CONCAT_NAME(__optional_var__, __COUNTER__), lhs, rexpr)
