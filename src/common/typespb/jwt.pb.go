...
type JWTClaims_DeviceClaims struct {
	DeviceClaims *DeviceJWTClaims `protobuf:"bytes,11,opt,name=device_claims,json=deviceClaims,proto3,oneof" json:"device_claims,omitempty"`
}

func (*JWTClaims_UserClaims) isJWTClaims_CustomClaims()    {}
func (*JWTClaims_ServiceClaims) isJWTClaims_CustomClaims() {}
func (*JWTClaims_DeviceClaims) isJWTClaims_CustomClaims()  {}
...
func (m *JWTClaims) GetDeviceClaims() *DeviceJWTClaims {
	if x, ok := m.GetCustomClaims().(*JWTClaims_DeviceClaims); ok {
		return x.DeviceClaims
	}
	return nil
}
...
type DeviceJWTClaims struct {
	DeviceID    string `protobuf:"bytes,1,opt,name=device_id,json=deviceId,proto3" json:"deviceID"`
	FleetID     string `protobuf:"bytes,2,opt,name=fleet_id,json=fleetId,proto3" json:"fleetID"`
	DeployKeyID string `protobuf:"bytes,3,opt,name=deploy_key_id,json=deployKeyId,proto3" json:"deployKeyID"`
}

func (m *DeviceJWTClaims) Reset()      { *m = DeviceJWTClaims{} }
func (*DeviceJWTClaims) ProtoMessage() {}
func (*DeviceJWTClaims) Descriptor() ([]byte, []int) {
	return fileDescriptor_069bb582df140411, []int{3}
}
func (m *DeviceJWTClaims) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *DeviceJWTClaims) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_DeviceJWTClaims.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *DeviceJWTClaims) XXX_Merge(src proto.Message) {
	xxx_messageInfo_DeviceJWTClaims.Merge(m, src)
}
func (m *DeviceJWTClaims) XXX_Size() int {
	return m.Size()
}
func (m *DeviceJWTClaims) XXX_DiscardUnknown() {
	xxx_messageInfo_DeviceJWTClaims.DiscardUnknown(m)
}

var xxx_messageInfo_DeviceJWTClaims proto.InternalMessageInfo

func (m *DeviceJWTClaims) GetDeviceID() string {
	if m != nil {
		return m.DeviceID
	}
	return ""
...
func (m *DeviceJWTClaims) GetFleetID() string {
	if m != nil {
		return m.FleetID
	}
	return ""
...
func (m *DeviceJWTClaims) GetDeployKeyID() string {
	if m != nil {
...
func init() {
	...
	proto.RegisterType((*DeviceJWTClaims)(nil), "gml.types.DeviceJWTClaims")
}
...
var fileDescriptor_069bb582df140411 = []byte{
	...
	,
}
...
func (this *JWTClaims_DeviceClaims) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*JWTClaims_DeviceClaims)
	if !ok {
		that2, ok := that.(JWTClaims_DeviceClaims)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if !this.DeviceClaims.Equal(that1.DeviceClaims) {
		return false
	}
	return true
}
...
func (this *DeviceJWTClaims) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*DeviceJWTClaims)
	if !ok {
		that2, ok := that.(DeviceJWTClaims)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if this.FleetID != that1.FleetID {
		return false
	}
	if this.DeployKeyID != that1.DeployKeyID {
		return false
	}
	return true
}
...
func (this *JWTClaims_DeviceClaims) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&typespb.JWTClaims_DeviceClaims{` +
		`DeviceClaims:` + fmt.Sprintf("%#v", this.DeviceClaims) + `}`}, ", ")
	return s
}
...
func (this *DeviceJWTClaims) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 7)
	s = append(s, "&typespb.DeviceJWTClaims{")
...
func (m *JWTClaims_DeviceClaims) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *JWTClaims_DeviceClaims) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.DeviceClaims != nil {
		{
			size, err := m.DeviceClaims.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *DeviceJWTClaims) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *DeviceJWTClaims) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *DeviceJWTClaims) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if len(m.DeployKeyID) > 0 {
		i -= len(m.DeployKeyID)
		copy(dAtA[i:], m.DeployKeyID)
		i = encodeVarintJwt(dAtA, i, uint64(len(m.DeployKeyID)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.FleetID) > 0 {
		...
		i = encodeVarintJwt(dAtA, i, uint64(len(m.FleetID)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.DeviceID) > 0 {
		...
		i = encodeVarintJwt(dAtA, i, uint64(len(m.DeviceID)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *JWTClaims_DeviceClaims) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *DeviceJWTClaims) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (this *JWTClaims_DeviceClaims) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&JWTClaims_DeviceClaims{`,
		`DeviceClaims:` + strings.Replace(fmt.Sprintf("%v", this.DeviceClaims), "DeviceJWTClaims", "DeviceJWTClaims", 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func (this *DeviceJWTClaims) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&DeviceJWTClaims{`,
		`DeviceID:` + fmt.Sprintf("%v", this.DeviceID) + `,`,
		`FleetID:` + fmt.Sprintf("%v", this.FleetID) + `,`,
		`DeployKeyID:` + fmt.Sprintf("%v", this.DeployKeyID) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *JWTClaims) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 11:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field DeviceClaims", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.CustomClaims = &JWTClaims_DeviceClaims{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
...
func (m *DeviceJWTClaims) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: DeviceJWTClaims: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: DeviceJWTClaims: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
