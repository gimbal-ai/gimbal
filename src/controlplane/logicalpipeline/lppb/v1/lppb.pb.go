...
type ParseLogicalPipelineYAMLRequest struct {
	Yaml string `protobuf:"bytes,1,opt,name=yaml,proto3" json:"yaml,omitempty"`
}

func (m *ParseLogicalPipelineYAMLRequest) Reset()      { *m = ParseLogicalPipelineYAMLRequest{} }
func (*ParseLogicalPipelineYAMLRequest) ProtoMessage() {}
func (*ParseLogicalPipelineYAMLRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_88d942c18068ffdb, []int{7}
}
func (m *ParseLogicalPipelineYAMLRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ParseLogicalPipelineYAMLRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ParseLogicalPipelineYAMLRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *ParseLogicalPipelineYAMLRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ParseLogicalPipelineYAMLRequest.Merge(m, src)
}
func (m *ParseLogicalPipelineYAMLRequest) XXX_Size() int {
	return m.Size()
}
func (m *ParseLogicalPipelineYAMLRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_ParseLogicalPipelineYAMLRequest.DiscardUnknown(m)
}

var xxx_messageInfo_ParseLogicalPipelineYAMLRequest proto.InternalMessageInfo

func (m *ParseLogicalPipelineYAMLRequest) GetYaml() string {
	if m != nil {
		return m.Yaml
	}
	return ""
...
type ParseLogicalPipelineYAMLResponse struct {
	LogicalPipeline *v1.LogicalPipeline `protobuf:"bytes,1,opt,name=logical_pipeline,json=logicalPipeline,proto3" json:"logical_pipeline,omitempty"`
}

func (m *ParseLogicalPipelineYAMLResponse) Reset()      { *m = ParseLogicalPipelineYAMLResponse{} }
func (*ParseLogicalPipelineYAMLResponse) ProtoMessage() {}
func (*ParseLogicalPipelineYAMLResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_88d942c18068ffdb, []int{8}
}
func (m *ParseLogicalPipelineYAMLResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ParseLogicalPipelineYAMLResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ParseLogicalPipelineYAMLResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *ParseLogicalPipelineYAMLResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ParseLogicalPipelineYAMLResponse.Merge(m, src)
}
func (m *ParseLogicalPipelineYAMLResponse) XXX_Size() int {
	return m.Size()
}
func (m *ParseLogicalPipelineYAMLResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_ParseLogicalPipelineYAMLResponse.DiscardUnknown(m)
}

var xxx_messageInfo_ParseLogicalPipelineYAMLResponse proto.InternalMessageInfo

func (m *ParseLogicalPipelineYAMLResponse) GetLogicalPipeline() *v1.LogicalPipeline {
	if m != nil {
		return m.LogicalPipeline
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*ParseLogicalPipelineYAMLRequest)(nil), "gml.internal.controlplane.logicalpipeline.v1.ParseLogicalPipelineYAMLRequest")
	proto.RegisterType((*ParseLogicalPipelineYAMLResponse)(nil), "gml.internal.controlplane.logicalpipeline.v1.ParseLogicalPipelineYAMLResponse")
}
...
var fileDescriptor_88d942c18068ffdb = []byte{
	...
	,
}
...
func (this *ParseLogicalPipelineYAMLRequest) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*ParseLogicalPipelineYAMLRequest)
	if !ok {
		that2, ok := that.(ParseLogicalPipelineYAMLRequest)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *ParseLogicalPipelineYAMLResponse) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*ParseLogicalPipelineYAMLResponse)
	if !ok {
		that2, ok := that.(ParseLogicalPipelineYAMLResponse)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *ParseLogicalPipelineYAMLRequest) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 5)
	s = append(s, "&lppb.ParseLogicalPipelineYAMLRequest{")
	s = append(s, "Yaml: "+fmt.Sprintf("%#v", this.Yaml)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
func (this *ParseLogicalPipelineYAMLResponse) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 5)
	s = append(s, "&lppb.ParseLogicalPipelineYAMLResponse{")
	if this.LogicalPipeline != nil {
		s = append(s, "LogicalPipeline: "+fmt.Sprintf("%#v", this.LogicalPipeline)+",\n")
	}
	s = append(s, "}")
...
type LogicalPipelineServiceClient interface {
	...
	ParseLogicalPipelineYAML(ctx context.Context, in *ParseLogicalPipelineYAMLRequest, opts ...grpc.CallOption) (*ParseLogicalPipelineYAMLResponse, error)
}
...
func (c *logicalPipelineServiceClient) ParseLogicalPipelineYAML(ctx context.Context, in *ParseLogicalPipelineYAMLRequest, opts ...grpc.CallOption) (*ParseLogicalPipelineYAMLResponse, error) {
	out := new(ParseLogicalPipelineYAMLResponse)
	err := c.cc.Invoke(ctx, "/gml.internal.controlplane.logicalpipeline.v1.LogicalPipelineService/ParseLogicalPipelineYAML", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type LogicalPipelineServiceServer interface {
	...
	ParseLogicalPipelineYAML(context.Context, *ParseLogicalPipelineYAMLRequest) (*ParseLogicalPipelineYAMLResponse, error)
}
...
func (*UnimplementedLogicalPipelineServiceServer) ParseLogicalPipelineYAML(ctx context.Context, req *ParseLogicalPipelineYAMLRequest) (*ParseLogicalPipelineYAMLResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ParseLogicalPipelineYAML not implemented")
}
...
func _LogicalPipelineService_ParseLogicalPipelineYAML_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ParseLogicalPipelineYAMLRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(LogicalPipelineServiceServer).ParseLogicalPipelineYAML(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/gml.internal.controlplane.logicalpipeline.v1.LogicalPipelineService/ParseLogicalPipelineYAML",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LogicalPipelineServiceServer).ParseLogicalPipelineYAML(ctx, req.(*ParseLogicalPipelineYAMLRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _LogicalPipelineService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ParseLogicalPipelineYAML",
			Handler:    _LogicalPipelineService_ParseLogicalPipelineYAML_Handler,
		},
	},
...
func (m *ParseLogicalPipelineYAMLRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ParseLogicalPipelineYAMLRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ParseLogicalPipelineYAMLRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *ParseLogicalPipelineYAMLResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ParseLogicalPipelineYAMLResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ParseLogicalPipelineYAMLResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *ParseLogicalPipelineYAMLRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ParseLogicalPipelineYAMLResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (this *ParseLogicalPipelineYAMLRequest) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&ParseLogicalPipelineYAMLRequest{`,
		`Yaml:` + fmt.Sprintf("%v", this.Yaml) + `,`,
		`}`,
	}, "")
	return s
}
func (this *ParseLogicalPipelineYAMLResponse) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&ParseLogicalPipelineYAMLResponse{`,
		`LogicalPipeline:` + strings.Replace(fmt.Sprintf("%v", this.LogicalPipeline), "LogicalPipeline", "v1.LogicalPipeline", 1) + `,`,
		`}`,
	}, "")
	return s
...
func (m *ParseLogicalPipelineYAMLRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ParseLogicalPipelineYAMLRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ParseLogicalPipelineYAMLRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *ParseLogicalPipelineYAMLResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ParseLogicalPipelineYAMLResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ParseLogicalPipelineYAMLResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
