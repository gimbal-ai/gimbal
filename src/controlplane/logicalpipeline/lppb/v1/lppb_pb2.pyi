...
class CreateLogicalPipelineRequest(_message.Message):
    __slots__ = ["name", "org_id", "pipeline"]
    ...
    def __init__(self, org_id: _Optional[_Union[_uuid_pb2.UUID, _Mapping]] = ..., name: _Optional[str] = ..., pipeline: _Optional[_Union[_model_exec_pb2.Pipeline, _Mapping]] = ...) -> None: ...
...
class GetLogicalPipelineResponse(_message.Message):
    __slots__ = ["pipeline", "pipeline_info"]
    PIPELINE_FIELD_NUMBER: _ClassVar[int]
    PIPELINE_INFO_FIELD_NUMBER: _ClassVar[int]
    pipeline: _model_exec_pb2.Pipeline
    pipeline_info: LogicalPipelineInfo
    def __init__(self, pipeline: _Optional[_Union[_model_exec_pb2.Pipeline, _Mapping]] = ..., pipeline_info: _Optional[_Union[LogicalPipelineInfo, _Mapping]] = ...) -> None: ...
