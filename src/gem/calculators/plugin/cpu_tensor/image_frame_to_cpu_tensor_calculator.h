...
/**
 * ImageFrameToCPUTensorCalculator Graph API:
 *
 *  Input Side Packets:
 ...
 *  Outputs:
 *    IMAGE_SHAPE CPUTensorPtr containing the input image.
 *
 */
class ImageFrameToCPUTensorCalculator : public ExecutionContextBaseCalculator {
 public:
