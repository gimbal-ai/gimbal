...
/**
 * Provides a simple access model to an opencv camera or video stream.
 */
class OpenCVCam : public OpenCVSource {
 public:
  OpenCVCam(const std::string& device_filename, const std::vector<int>& params,
