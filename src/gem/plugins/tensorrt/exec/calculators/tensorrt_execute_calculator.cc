...
#include "src/gem/plugins/tensorrt/exec/calculators/tensorrt_execute_calculator.h"
...
Status TensorRTExecuteCalculator::OpenImpl(mediapipe::CalculatorContext*,
                                           tensorrt::ExecutionContext* exec_ctx) {
  output_allocator_ =
...
Status TensorRTExecuteCalculator::CloseImpl(mediapipe::CalculatorContext*,
