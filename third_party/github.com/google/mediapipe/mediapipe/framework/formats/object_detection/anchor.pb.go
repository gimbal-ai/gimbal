...
type Anchor struct {
	...
	H       float32 `protobuf:"fixed32,3,req,name=h" json:"h"`
	W       float32 `protobuf:"fixed32,4,req,name=w" json:"w"`
}

func (m *Anchor) Reset()      { *m = Anchor{} }
func (*Anchor) ProtoMessage() {}
func (*Anchor) Descriptor() ([]byte, []int) {
	return fileDescriptor_06ce68ffe6f8a7da, []int{0}
}
...
func (m *Anchor) GetXCenter() float32 {
	if m != nil {
		return m.XCenter
	}
	return 0
...
func (m *Anchor) GetYCenter() float32 {
	if m != nil {
		return m.YCenter
	}
	return 0
...
func init() {
	proto.RegisterType((*Anchor)(nil), "mediapipe.Anchor")
}

func init() {
	proto.RegisterFile("mediapipe/framework/formats/object_detection/anchor.proto", fileDescriptor_06ce68ffe6f8a7da)
}

var fileDescriptor_06ce68ffe6f8a7da = []byte{
	// 235 bytes of a gzipped FileDescriptorProto
	,
}

func (this *Anchor) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*Anchor)
	if !ok {
		that2, ok := that.(Anchor)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *Anchor) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 8)
	s = append(s, "&object_detection.Anchor{")
...
func valueToGoStringAnchor(v interface{}, typ string) string {
...
func (m *Anchor) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	dAtA[i] = 0x25
	i -= 4
	encoding_binary.LittleEndian.PutUint32(dAtA[i:], uint32(math.Float32bits(float32(m.H))))
	i--
	dAtA[i] = 0x1d
	i -= 4
...
func (this *Anchor) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&Anchor{`,
...
func valueToStringAnchor(v interface{}) string {
	rv := reflect.ValueOf(v)
	if rv.IsNil() {
		return "nil"
	}
...
func (m *Anchor) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			v = uint32(encoding_binary.LittleEndian.Uint32(dAtA[iNdEx:]))
			iNdEx += 4
			m.H = float32(math.Float32frombits(v))
	...
	if hasFields[0]&uint64(0x00000004) == 0 {
		return github_com_gogo_protobuf_proto.NewRequiredNotSetError("h")
	}
	if hasFields[0]&uint64(0x00000008) == 0 {
		return github_com_gogo_protobuf_proto.NewRequiredNotSetError("w")
	}
