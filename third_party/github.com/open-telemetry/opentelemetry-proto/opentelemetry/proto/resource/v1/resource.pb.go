...
var fileDescriptor_446f73eacf88f3f5 = []byte{
	...
	0x75, 0xda, 0xce, 0x78, 0xe1, 0xa1, 0x1c, 0xc3, 0x8d, 0x87, 0x72, 0x0c, 0x1f, 0x1e, 0xca, 0x31,
	...
	0xe5, 0x18, 0x2e, 0x3c, 0x96, 0x63, 0xb8, 0xf1, 0x58, 0x8e, 0x81, 0x4b, 0x29, 0x33, 0x5f, 0x8f,
	0x40, 0xb0, 0x38, 0xf1, 0xc2, 0xfc, 0x19, 0x00, 0x92, 0x0a, 0x60, 0x8c, 0xd2, 0x4a, 0x47, 0xd7,
	0x94, 0x99, 0x0f, 0x0d, 0xad, 0xfc, 0x92, 0x9c, 0x02, 0xe4, 0x38, 0x58, 0xc5, 0x24, 0xef, 0x5f,
	0x90, 0x9a, 0x17, 0x02, 0x57, 0x09, 0x36, 0x43, 0x0f, 0x66, 0xa2, 0x5e, 0x98, 0x61, 0x12, 0x1b,
	0x58, 0xa7, 0x31, 0x20, 0x00, 0x00, 0xff, 0xff, 0x7f, 0x4a, 0x49, 0x82, 0xcf, 0x01, 0x00, 0x00,
}
...
func (this *Resource) String() string {
	...
	for _, f := range this.Attributes {
		repeatedStringForAttributes += strings.Replace(fmt.Sprintf("%v", f), "KeyValue", "v1.KeyValue", 1) + ","
	}
