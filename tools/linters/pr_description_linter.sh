...
# Check that there's a Relevant Issues field.
echo "$PR_BODY" | grep -E "^Relevant Issues: .+" >/dev/null || bad_description "PR description must include Relevant Issues: <IssueID or N/A>"
